...
public class PESTAÑAS extends JFrame implements ActionListener {
	...
	private void HazInterfaz(){
		...
		P.addTab("Datos Generales", Rutinas.AjustarImagen("AVION.PNG",40,30),JS, "información del empleado");
		P.addTab("Finanzas", Rutinas.AjustarImagen("CABALLO.JPG",40,30), Panel2, "situación económica");
