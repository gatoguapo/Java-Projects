...
public class ComponenteV3 extends JPanel implements ComponentListener, ActionListener{
	...
	public void componentResized(ComponentEvent arg0) {
		...
		lblNombre.setBounds((int)(w*0.10),(int)(h*0.28),50,10);
		lblCarrera.setBounds((int)(w*0.10),(int)(h*0.48),50,10);
		
		txtNoControl.setBounds((int)(w*0.08)+lblNoControl.getWidth()+20,(int)(h*0.05),150,20);
		txtNombre.setBounds   ((int)(w*0.08)+lblNoControl.getWidth()+20,(int)(h*0.25),300,20);
		txtCarrera.setBounds((int)(w*0.08)+lblNoControl.getWidth()+20,(int)(h*0.45),300,20);
